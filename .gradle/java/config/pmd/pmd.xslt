    ...
    <xsl:template match="pmd">
        <html>
            ...
            <body>
                <H1>
                    <div class="top">
                        <div class="left">PMD <xsl:value-of select="//pmd/@version"/> Report</div>
                        <div class="right">
                        ...
                        <xsl:for-each select="violation">
                            <tr>
                                ...
                                <td style="padding: 3px" align="left">
                                    <xsl:value-of disable-output-escaping="yes" select="substring-after(../@name, '/src/')"/>
                                </td>
                                <td style="padding: 3px" align="right">
                ...
                <br/>
                <p>Generated by <a href="http://pmd.sourceforge.net">PMD <b>
                            <xsl:value-of select="//pmd/@version"/>
                        </b>
                    </a> on <xsl:call-template name="timestamp"/>.</p>
            </body>
        </html>
    </xsl:template>
